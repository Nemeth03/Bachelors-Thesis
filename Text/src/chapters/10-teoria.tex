...
Druhý model je Gilbertov model, $G_{N,p}$, takisto obsahuje $n = |N|$ vrcholov, však hrany nie sú pridelené pevným počtom,
...
$\lambda$ je priemerný stupeň vrchola, ktorý je daný vzorcom \ref{eq:avg_degree_gilbert}.
